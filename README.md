...
![SCSS](https://img.shields.io/badge/SCSS-EF460B?style=for-the-badge)
...
| :--- | :--- | :--- |
| **[Link-Map](https://github.com/LM-official/Link-Map)** | 🗺️ A personal knowledge base — a digital garden of interlinked notes, published as an interactive graph with Quartz. | `TypeScript` `SCSS` |
...
🤖 The `Tech Stack` and `Projects developed` sections are generated automatically from my public repositories — `Names`, `About` descriptions and detected `Languages` — by [a script](scripts/update_projects.py) that [GitHub Actions](.github/workflows/update-readme.yml) runs every day.
